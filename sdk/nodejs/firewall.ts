...
export class Firewall extends pulumi.CustomResource {
     ...
     * to the Firewall.
     */
    public readonly dropletIds: pulumi.Output<string[] | undefined>;
    /**
...
export interface FirewallState {
     ...
     * The `inbound_rule` block is documented below.
     */
    readonly inboundRules?: pulumi.Input<{ portRange?: pulumi.Input<string>, protocol?: pulumi.Input<string>, sourceAddresses?: pulumi.Input<pulumi.Input<string>[]>, sourceDropletIds?: pulumi.Input<pulumi.Input<number>[]>, sourceLoadBalancerUids?: pulumi.Input<pulumi.Input<string>[]>, sourceTags?: pulumi.Input<pulumi.Input<string>[]> }[]>;
    /**
     * The Firewall name
     */
     ...
     * have been successfully applied.
     */
    readonly pendingChanges?: pulumi.Input<{ dropletId?: pulumi.Input<number>, removing?: pulumi.Input<boolean>, status?: pulumi.Input<string> }[]>;
    /**
     * A status string indicating the current state of the Firewall.
     * This can be "waiting", "succeeded", or "failed".
     */
