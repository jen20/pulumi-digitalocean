PROJECT_NAME := Digital Ocean Package
include build/common.mk

PACK             := digitalocean
PACKDIR          := sdk
PROJECT          := github.com/jen20/pulumi-digitalocean
NODE_MODULE_NAME := @jen20/digitalocean
...
build::
	go install -ldflags "-X github.com/jen20/pulumi-digitalocean/pkg/version.Version=${VERSION}" ${PROJECT}/cmd/${TFGEN}
	go install -ldflags "-X github.com/jen20/pulumi-digitalocean/pkg/version.Version=${VERSION}" ${PROJECT}/cmd/${PROVIDER}
